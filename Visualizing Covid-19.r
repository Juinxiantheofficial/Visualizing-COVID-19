...
ggplot(china_after_feb15, aes(date, cum_cases)) + geom_line()+
...
ggplot(confirmed_cases_top7_outside_china) + geom_line(aes(date,cum_cases,color=country)) +  ylab("Cumulative confirmed cases")
